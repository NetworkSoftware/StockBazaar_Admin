...
public class SellerRequestAdapter extends RecyclerView.Adapter<SellerRequestAdapter.MyViewHolder> {
    ...
    public SellerRequestAdapter(Context context, List<Seller> sellers, SellerClick sellerClick) {
