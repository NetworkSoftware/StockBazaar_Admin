...
public class SellerPendingAdapter extends RecyclerView.Adapter<SellerPendingAdapter.MyViewHolder> {
    ...
    public SellerPendingAdapter(Context context, List<Seller> sellers, SellerClick sellerClick) {
