...
public class FirebaseMessageReceiver extends FirebaseMessagingService {
    ...
    public void showNotification(String title, String message) {
        ...
        String user = sharedPreferences.contains("user") ? sharedPreferences.getString("user", "") : "";
        if ("9787665726".equalsIgnoreCase(user) ||
                "7010504536".equalsIgnoreCase(user) ||
                "9514414404".equalsIgnoreCase(user) ||
                "9787665854".equalsIgnoreCase(user)) {
            Intent intent = new Intent(this, NaviActivity.class);
            String channel_id = "airing_web_app_channel";
