...
public class PdfConfigInvoice {
    ...
    private static final BaseColor greenBase = new BaseColor(207,97,134);
    private static final BaseColor greenLightBase = new BaseColor(255,64,129);
    private static Font invoiceFont = new Font(urName, 20, Font.BOLD, greenBase);
    private static Font catNormalFontTitel = new Font(urName, 16, Font.BOLD);
    ...
    public static void addContent(Document document, Order myorderBean, Context context) throws Exception {
        ...
        table21.addCell(createTextCell("Order Id :" + myorderBean.getId(), catNormalFont));
        table21.addCell(createTextCell("\n", nameFont));
        table21.addCell(createTextCell("Delivery Details", nameFont));
        table21.addCell(createTextCell("Mode :" + "Speed delivery", catNormalFont));
        ...
        table21.addCell(createTextCell("Estimate Time :" + "3-4 days from date of booking", catNormalFont));
        ...
        for (int i = 0; i < myorderBean.getProductBeans().size(); i++) {
            CartItems productListBean = myorderBean.getProductBeans().get(i);
            int quan = Integer.parseInt(productListBean.getQuantity());
            ...
            if(i==myorderBean.getProductBeans().size()-1){
                ...
                table3.addCell(createTextCellBottomWithRight(productListBean.getName(), catFont));
                table3.addCell(createTextCellqutWithBottom(productListBean.getQuantity(), catNormalFont));
                ...
                table3.addCell(createTextCellBottom(productListBean.getName(), catFont));
                table3.addCell(createTextCellqut(productListBean.getQuantity(), catNormalFont));
        ...
        table4.addCell(TableTextRight("COD Charge :", catNormalFont));
        table4.addCell(TableTextRightpaddind(myorderBean.getSpecialCost(), catNormalFont));
    ...
    public static PdfPCell createTextCellTableTo(String text, Font font) throws DocumentException, IOException {
    ...
    public static PdfPCell createTextCellTopqut(String text, Font font) throws DocumentException, IOException {
        PdfPCell cell = new PdfPCell();
        Paragraph p = new Paragraph(text, font);
        p.setAlignment(Element.ALIGN_CENTER);
        cell.addElement(p);
    ...
    public static PdfPCell createTextCellTotal(String text, Font font) throws DocumentException, IOException {
        PdfPCell cell = new PdfPCell();
        Paragraph p = new Paragraph(text, font);
        p.setAlignment(Element.ALIGN_RIGHT);
        cell.addElement(p);
